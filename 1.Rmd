...
The confusion matricies are as follows:  
**Validation set**:  
```{r cache=FALSE}
...
### c. Random Forest  
Here I try to apply Random Forest, I defined a grid **RF** in H2O, then run grid search using different max tree depth and variables each tree, then I choose the best model with highest F2 metric.  
